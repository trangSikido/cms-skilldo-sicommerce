<div class="products-detail">
    ...
    <div class="row">
        ...
        <div class="col-md-3 sidebar">
             ...
             */
            do_action( 'woocommerce_products_detail_support', $object ); //ver 2.2.0
    ...
    <div class="row">
        <div class="col-md-9">
             ...
             */
            do_action( 'woocommerce_products_detail_tabs', $object ); //ver 2.2.0
        ...
        <div class="col-md-3 sidebar">
             ...
             */
            do_action( 'woocommerce_products_detail_sidebar', $object ); //ver 2.2.0
